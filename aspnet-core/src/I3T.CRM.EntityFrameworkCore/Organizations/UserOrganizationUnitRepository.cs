...
namespace I3T.CRM.Organizations
{
    public class UserOrganizationUnitRepository : CRMRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<CRMDbContext> dbContextProvider)
