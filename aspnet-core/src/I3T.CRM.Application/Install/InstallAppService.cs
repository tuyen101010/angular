...
using I3T.CRM.Migrations.Seed;
using I3T.CRM.Migrations.Seed.Host;
...
namespace I3T.CRM.Install
{
    ...
    public class InstallAppService : CRMAppServiceBase, IInstallAppService
    {
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CRMConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CRMConsts.ConnectionStringName}", constring);
        }
