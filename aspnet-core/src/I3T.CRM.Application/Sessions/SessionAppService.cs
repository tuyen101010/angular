            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = CRMConsts.Currency,
                        CurrencySign = CRMConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = CRMConsts.AllowTenantsToChangeEmailSettings,
                ...
                if (AbpSession.TenantId.HasValue)
                {
                    ...
                    output.TenantCustomPages = TenantCustomPagesCache.GetList(AbpSession.TenantId.Value);
                }
