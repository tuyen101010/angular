...
using I3T.CRM.Authorization.Users.Profile.Cache;
...
using I3T.CRM.Timing;
using SixLabors.ImageSharp;
using SixLabors.ImageSharp.Formats;
using SixLabors.ImageSharp.Processing;

namespace I3T.CRM.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CRMAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("I3T.CRM",
