...
using I3T.CRM.Controls;
using I3T.CRM.Dto;
using I3T.CRM.Extensions;
using I3T.CRM.Localization;
using I3T.CRM.UI;
using I3T.CRM.UI.Assets;
using I3T.CRM.Views;
using DependencyResolver = I3T.CRM.Core.Dependency.DependencyResolver;
