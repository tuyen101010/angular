...
using I3T.CRM.Authorization.Ldap;
using I3T.CRM.Authorization.Roles;
using I3T.CRM.Authorization.Users;
using I3T.CRM.Chat;
using I3T.CRM.Configuration;
using I3T.CRM.DashboardCustomization.Definitions;
using I3T.CRM.Debugging;
using I3T.CRM.DynamicEntityProperties;
using I3T.CRM.Features;
using I3T.CRM.Friendships;
using I3T.CRM.Friendships.Cache;
using I3T.CRM.Localization;
using I3T.CRM.MultiTenancy;
using I3T.CRM.Net.Emailing;
using I3T.CRM.Notifications;
using I3T.CRM.WebHooks;
using Newtonsoft.Json;

namespace I3T.CRM
{
    [DependsOn(
        typeof(CRMCoreSharedModule),
    ...
    public class CRMCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CRMMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
