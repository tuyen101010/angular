...
namespace I3T.CRM.Web.TagHelpers
{
    ...
    public class CRMPageSubheaderTagHelper : TagHelper
    {
        ...
        public CRMPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
        ...
        private string GetDescription()
        {
            ...
            return $@"<div class='subheader-separator subheader-separator-ver mt-2 mb-2 me-4 bg-gray-200'></div>
                       <span class='text-muted fw-bold me-4'>{Description}</span>";
        }
