...
using I3T.CRM.Web.Extensions;
using SecurityStampValidatorCallback = I3T.CRM.Identity.SecurityStampValidatorCallback;
...
namespace I3T.CRM.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<CRMWebMvcModule>(options =>
            {
