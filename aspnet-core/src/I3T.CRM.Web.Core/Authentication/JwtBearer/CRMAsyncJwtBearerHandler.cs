...
{
    public class CRMAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public CRMAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
