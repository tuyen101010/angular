...
using I3T.CRM.MultiTenancy.HostDashboard;
...
namespace I3T.CRM.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(CRMDbContext context, SubscriptionPayment subscriptionPayment)
        {
