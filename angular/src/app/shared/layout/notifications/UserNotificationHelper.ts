...
export class UserNotificationHelper extends AppComponentBase {
    ...
    format(userNotification: abp.notifications.IUserNotification, truncateText?: boolean): IFormattedUserNotification {
        let formatted: IFormattedUserNotification = {
            ...
            isHtml: this.isHTMLMessage(userNotification.notification.data.properties.Message),
            fullMessage: userNotification.notification.data.properties.Message
        };
    ...
    openDetailModal(content: string, isHtml: boolean) {
        this.detailModal.show(content, isHtml);
    }
}
