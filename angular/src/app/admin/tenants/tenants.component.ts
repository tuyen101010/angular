...
import { GroupJobSettingModalComponent } from './group-job-setting-modal.component';
...
export class TenantsComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('groupJobSettingModal', { static: true }) groupJobSettingModal: GroupJobSettingModalComponent;
    ...
    _entityTypeFullName = 'I3T.CRM.MultiTenancy.Tenant';
