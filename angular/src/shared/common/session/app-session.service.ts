...
export class AppSessionService {
    ...
    private _tenantCustomPages: TenantCustomPageItemDto[];
    ...
    get tenantCustomPages(): TenantCustomPageItemDto[] {
        return this._tenantCustomPages;
    }

    set tenantCustomPages(val: TenantCustomPageItemDto[]) {
        this._tenantCustomPages = val;
    }
            ...
            this._sessionService
                ...
                .then(
                    (result: GetCurrentLoginInformationsOutput) => {
                        ...
                        this._tenantCustomPages = result.tenantCustomPages;
