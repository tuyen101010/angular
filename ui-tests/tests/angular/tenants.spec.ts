...
describe('TENANTS', () => {
    ...
    describe('CRUD', () => {
        ...
        it('should display modal on click to "New" button', async () => {
            ...
            await Utils.waitForModal('createModal');
        ...
        it('should hide error when form is properly filled', async () => {
            ...
            await Utils.triggerValidation('#TenancyName', '#Name', '#AdminEmailAddress', '#adminPassword', '#AdminPasswordRepeat');
        ...
        it('should display modal on click to "Edit" button', async () => {
            ...
            await Utils.waitForResponse();
            await Utils.waitForModal('editModal');
            await Utils.replaceLastColoumnOfTable();
        ...
        async function triggerValidation() {
            await fillInputsWithValidValues();
            await Utils.clearInputs('#TenancyName', '#Name', '#AdminEmailAddress', '#adminPassword', '#AdminPasswordRepeat');
        }
